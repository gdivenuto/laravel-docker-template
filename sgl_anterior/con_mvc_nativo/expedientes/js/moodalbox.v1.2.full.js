...
var _ERROR_MESSAGE = "Oops.. ha surgido un error en la respuesta.<br /><br />" +
					"Pruebe nuevamente.<br /><br />" +
...
var _EVAL_SCRIPTS			= true;		// Opción para evaluar el script en el texto de la respuesta
var _EVAL_RESPONSE			= false;	// Opción para evaluar el texto de la respuesta general
