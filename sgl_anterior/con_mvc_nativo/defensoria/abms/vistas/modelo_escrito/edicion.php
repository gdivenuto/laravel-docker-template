...
class VistaModeloEscritoEdicion extends VistaBase {
			    ...
			    <div class="container-fluid p-0 px-3">
					...
					<div class="row">
						<div class="col fuente_titulos bg-dark text-white small py-1 titulo_entidad">
							<?=$titulo_operacion;?> del Modelo de Proceso
						</div>
					</div>
						...
						<div class="row my-1">
							<div class="col-md-6">
								<div class="form-group row mt-1">
									<label for="nombre" class="col-sm-3 control-label small text-left text-md-right color_resaltado pt-1">* Nombre</label>
									<div class="col-sm-8">
								...
								<div class="form-group row mt-1">
									<label for="descripcion" class="col-sm-3 control-label small text-left text-md-right color_resaltado pt-1">* Descripci&oacute;n</label>
									<div class="col-sm-8">
										<input type="text" id="descripcion" name="descripcion" value="<?=(isset($datos['descripcion'])) ? htmlspecialchars($datos['descripcion']) : '';?>" class="form-control form-control-sm" >
									</div>
								</div>
								<div class="row mt-3">
