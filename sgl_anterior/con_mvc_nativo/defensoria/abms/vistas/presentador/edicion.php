...
class VistaPresentadorEdicion extends VistaBase {
			    ...
			    <div class="container-fluid p-0 px-3">
					...
					<div class="row">
						<div class="col fuente_titulos bg-dark text-white small py-1 titulo_entidad">
							<?=$titulo_operacion;?> del Presentante
						</div>
					</div>

					<form id="formEdicion" name="formEdicion" class="form-horizontal" action="<?=URL_ABMS;?>" method="POST" enctype="multipart/form-data">
						...
						<div class="row my-1">
							<div class="col-md-8 mx-auto">
								<div class="form-group row mt-1">
									...
									<label for="apellido" class="col-sm-2 control-label small text-left text-sm-right color_resaltado pt-1">* Apellido</label>
									<div class="col-sm-4">
								...
								<div class="form-group row mt-1">
									<label for="mail" class="col-sm-2 control-label small text-left text-sm-right color_resaltado pt-1">* Mail</label>
									<div class="col-sm-6">
										<div class="input-group">
											<div class="input-group-prepend">
									...
									<label for="dni" class="col-sm-2 control-label small text-left text-sm-right color_resaltado pt-1">* DNI</label>
									<div class="col-sm-2">
										<input 
											type="number" 
											id="dni" 
