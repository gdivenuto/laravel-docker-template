...
class VistaTipoProcesoEdicion extends VistaBase {

	public function __construct() {
		parent::__construct();
		$this->controlador = 'tipo_proceso';
	}
			    ...
			    <div class="container-fluid p-0 px-3">
					...
					<div class="row">
						<div class="col fuente_titulos bg-dark text-white small py-1 titulo_entidad">
							<?=$titulo_operacion;?> del Tipo de Proceso
						</div>
					</div>
						...
						<div class="row my-1">
							<div class="col-md-6">
								<div class="form-group row mt-1">
									<label for="nombre" class="col-sm-2 control-label small text-left text-md-right text-info pt-1">* Nombre</label>
									<div class="col-sm-10">
