...
require_once RUTA_VISTAS . "presentador/grilla.php";
require_once RUTA_VISTAS . "presentador/edicion.php";
//require_once RUTA_VISTAS . "presentador/informe_pdf.php";

class PresentadorController extends ControladorBase {
	...
	public function __construct() {
		...
		$this->modelo = new PresentadorModel();
		$this->modelo_provincia = new ProvinciaModel();

		$this->vista_grilla = new VistaPresentadorGrilla();
		$this->vista_edicion = new VistaPresentadorEdicion();
		//$this->vista_pdf = new VistaPresentadorInformePDF();
	}
