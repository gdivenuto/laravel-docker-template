...
require_once RUTA_MODELOS . "ModeloEscrito.php";

require_once RUTA_VISTAS . "modelo_escrito/grilla.php";
require_once RUTA_VISTAS . "modelo_escrito/edicion.php";

class Modelo_EscritoController extends ControladorBase {
	...
	public function __construct() {
		...
		$this->modelo = new ModeloEscritoModel();

		$this->vista_grilla = new VistaModeloEscritoGrilla();
		$this->vista_edicion = new VistaModeloEscritoEdicion();
	}
