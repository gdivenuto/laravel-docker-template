...
class VistaAuditoriaDefensoriaGrilla extends VistaBase {
	...
	public function __construct() {
		...
		$this->controlador = 'auditoria_defensoria';
	}
	...
	public function mostrar($datos, $filtro) {
		...
		<html lang="es">
		  	...
		  	<body>
			    <div class="container-fluid p-0 px-3">
					...
					<div class="row">
						<div class="col fuente_titulos bg-dark text-white small py-1 titulo_entidad">
							Auditor&iacute;a del Sistema de Defensor&iacute;a del Pueblo
						</div>
					</div>
					<!-- Buscador -->
					<div class="row mt-1">
								...
								<table class="table table-hover table-bordered table-sm small">
									...
									<tbody>
										...
										<tr>
											...
											<td class="text-right">
												<?= ($dato['id_registro'] != 'null') ? $dato['id_registro'] : '&nbsp;'; ?>
											</td>
											<td class="text-left">
			    ...
			    <script src="<?= URL_JS; ?>auditoria_defensoria/grilla.js?v=<?=date("Ymd_His");?>"></script>
		  	</body>
		</html>
		<?php }
}
