...
class VistaAuditoriaPersonalGrilla extends VistaBase {
	...
	public function __construct() {
		...
		$this->controlador = 'auditoria_personal';
	}
	...
	public function mostrar($datos, $filtro) {
		...
		<html lang="es">
		  	...
		  	<body>
			    <div class="container-fluid p-0 px-3">
					...
					<div class="row">
						<div class="col fuente_titulos bg-dark text-white small py-1 titulo_entidad">
							Auditor&iacute;a del Sistema de Personal
						</div>
					</div>
					<!-- Buscador -->
					<div class="row mt-1">
						<form class="form-inline" action="" method="POST" name="formBuscadorGrilla">
							...
							<input  type="text" name="f_usuario" id="f_usuario" 
									...
									class="form-control form-control-sm small mx-3" 
									placeholder="Usuario">

							<input  type="text" name="f_legajo" id="f_legajo" 
									value="<?= utf8_encode($filtro['f_legajo']); ?>" 
									class="form-control form-control-sm small mx-3" 
			    ...
			    <script src="<?= URL_JS; ?>auditoria_personal/grilla.js?v=<?=date("Ymd_His");?>"></script>
		  	</body>
		</html>
		<?php }
}
