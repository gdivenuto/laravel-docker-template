...
class VistaOpendataPublicadoresGrilla extends VistaBase {
	...
	public function __construct() {
		...
		$this->controlador = 'opendata_publicadores';
	}
	...
	public function mostrar($datos, $mensaje = '', $tipo_mensaje = '', $filtro) {
		...
		<html lang="es">
		  	...
		  	<body>
						...
						<div class="form-row">
							<div class="col-12 col-md-2 mt-1">
								<input type="text" name="f_titulo" id="f_titulo"
										value="<?= ($_SESSION['filtro_opendata_publicadores']['f_titulo']) ? $_SESSION['filtro_opendata_publicadores']['f_titulo'] : ''; ?>" 
										class="form-control form-control-sm small"
										placeholder="T&iacute;tulo" >
							</div>
							<div class="col-12 col-md-4 mt-1">
								<input  type="text" name="f_descripcion" id="f_descripcion" 
										value="<?= ($_SESSION['filtro_opendata_publicadores']['f_descripcion']) ? $_SESSION['filtro_opendata_publicadores']['f_descripcion'] : '';?>" 
										class="form-control form-control-sm small" 
									...
									<table class="table table-hover table-bordered table-sm small">
										...
										<?php for ($i = 0; $i < $cantidad; $i++) {$dato = &$datos[$i];?>
											<tr <?=($dato['habilitado'] == '0') ? ' class="text-muted"' : '';?> >
												...
												<td><?= ($dato['descripcion']) ? $dato['descripcion'] : '&nbsp;'; ?></td>
			    ...
			    <script src="<?=URL_JS;?>opendata_publicadores/grilla.js?v=<?=date("Ymd_His");?>"></script>
		  	</body>
		</html>
		<?php }
}
