...
class VistaOpendataCatalogosGrilla extends VistaBase {
	...
	public function mostrar($datos, $mensaje = '', $tipo_mensaje = '', $filtro) {
		...
		<html lang="es">
		  	...
		  	<body>
						...
						<div class="form-row">
							<div class="col-12 col-md-2 mt-1">
								<input type="text" name="f_titulo" id="f_titulo"
										value="<?= ($_SESSION['filtro_opendata_catalogos']['f_titulo']) ? $_SESSION['filtro_opendata_catalogos']['f_titulo'] : ''; ?>" 
										class="form-control form-control-sm small"
										placeholder="T&iacute;tulo" >
							</div>
							<div class="col-12 col-md-4 mt-1">
								<input  type="text" name="f_descripcion" id="f_descripcion" 
										value="<?= ($_SESSION['filtro_opendata_catalogos']['f_descripcion']) ? $_SESSION['filtro_opendata_catalogos']['f_descripcion'] : '';?>" 
										class="form-control form-control-sm small" 
			    ...
			    <script src="<?=URL_JS;?>opendata_catalogos/grilla.js?v=<?=date("Ymd_His");?>"></script>
		  	</body>
		</html>
		<?php }
}
