<?php
class VistaInscripcionesHabilitacion extends VistaBase {
	...
	?>
		<form 
			...
			<input type="hidden" id="candidato_id" name="candidato_id" value="<?=$datos['candidato_id'];?>" />

			<p>A continuaci&oacute;n puede habilitar o no al Candidato.<br>Puede especificar un motivo si lo desea.</p>
