...
class VistaOrdenComisionEdicionEncabezado extends VistaBase {
	 ...
	 */
	public function mostrar($id, $encabezado, $mensaje = '', $tipo_mensaje = '') {
		?>
		<!DOCTYPE html>
		<html lang="es">
		  	<head>
		  	...
		  	<body>
			    <div class="container-fluid p-0 px-3">
					...
					<div class="row">
						<div class="col fuente_titulos bg-dark text-white small py-1 titulo_entidad">
							Edici&oacute;n del Encabezado de la Orden.
						</div>
					</div>
					...
					<form id="formEdicion" name="formEdicion" class="form-horizontal" action="<?=URL_ABMS;?>" method="POST">
						...
						<input type="hidden" id="accion" name="accion" value="modificarEncabezado" />
							...
							<div class="col-11 mx-auto">
								<div class="form-group row">
									<textarea 
										...
										name="encabezado"
										class="form-control"
										aria-label="Texto"><?=html_entity_decode($encabezado);?></textarea>
								</div>
								<div class="row mt-3">
				...
				<script src="<?=URL_JS.$this->controlador;?>/edicion_encabezado.js?v=<?=date("Ymd_Hi");?>"></script>
		  	</body>
		</html>
		<?php }
}
