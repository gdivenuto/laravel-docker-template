...
/**
 * Capa de acceso a datos (persistencia) específica de la gestion de Firmas de Expediente Electrónico Pendiente.
 */
class DBFirmasExpedienteElecPend extends DBBaseClass {

	protected $t_expe_firmas_expediente_elec_pend = 'expe_firmas_expediente_elec_pend'; //!< Identificador de tabla 'expe_firmas_expediente_elec_pend'
	...
	/**
	 * DBFirmasExpedienteElecPend: Obtiene un array de filas correspondientes a la clase FirmaExpedienteElecPend en base a diferentes criterios de selección.
...
// HereDoc Start -----------------------------------------------------------------------------------
		...
		FROM 
			`{$this->t_expe_firmas_expediente_elec_pend}` as T
...
// HereDoc End -------------------------------------------------------------------------------------
	...
	/**
	 * DBFirmasExpedienteElecPend: Obtiene la cantidad de filas correspondientes de la clase FirmaExpedienteElecPend en base a una consulta con diferentes criterios de selección.
	 * GenerateClass 0.97.7 beta @ 2022-11-17 09:07:53
	 * @param  integer (PK) anio
	 * @param  string (PK) tipo
	 * @param  float (PK) numero
...
// HereDoc End -------------------------------------------------------------------------------------
	...
	/**
	 * DBFirmasExpedienteElecPend: Guarda una instancia de la clase FirmaExpedienteElecPend en la base de datos.
	 * GenerateClass 0.97.7 beta @ 2022-11-17 09:07:53
	 * @param  integer (PK) anio
	 * @param  string (PK) tipo
	 * @param  float (PK) numero
	 ...
	 */
	public function guardarFirmaExpedienteElecPend(
		// Parametros
		$panio = null,
		$ptipo = null,
		$pnumero = null,
	...
	/**
	 * DBFirmasExpedienteElecPend: Elimina un conjunto de FirmasExpedienteElecPend en base a diferentes criterios de selección.
	 * GenerateClass 0.97.7 beta @ 2022-11-17 09:07:53
	 * @param  integer (PK) anio
	 * @param  string (PK) tipo
	 * @param  float (PK) numero
		...
		$pobservaciones = null)
	{
		...
		if (is_null($panio) && is_null($ptipo) && is_null($pnumero) && is_null($pcuerpo) && is_null($palcance) && is_null($porden) && is_null($pid_firma) && is_null($pid_usuario) && is_null($pid_usuario_solicitante) && is_null($pobservaciones))
	...
	/**
	 * Obtiene el siguiente número de id firma para un documento de un expediente electronico pendiente.
	 ...
	 */
	public function obtenerFirmaExpedienteElecPendIdSiguiente(
		// Parametros
		$panio,
		$ptipo,
		$pnumero,
