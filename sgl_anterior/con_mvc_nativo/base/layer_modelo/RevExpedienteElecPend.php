<?php
/**
 * Clase RevExpedienteElecPend
 * 
 * Descripción: expe_rev_expediente_elec_pend 
 * Layer Datos: DBRevExpedienteElecPend
 * Layer Negocio: NGRevExpedienteElecPend
 *
 * GenerateClass 0.97.7 beta @ 2022-11-16 12:41:32
 */
class RevExpedienteElecPend extends ClaseBase {
	// ************************************************************************
	...
	protected $id_revision         ; // (Primary Key) PHP: integer    MySQL: smallint(6)
	protected $id_usuario          ; // PHP: integer    MySQL: int(10) unsigned
	protected $estado              ; // PHP: string     MySQL: enum('pendiente','confirmado','rechazado','descartado')
	...
	protected $ro_id_usuario_solicitante; // Asociado a ExpedienteElecPend->id_usuario
	protected $ro_codigo_usuario_solicitante; // Asociado a ro_id_usuario_solicitante
	protected $ro_nombre_usuario_solicitante; // Asociado a ro_id_usuario_solicitante
	protected $ro_mail_usuario_solicitante;   // Asociado a ro_id_usuario_solicitante
	...
	public function getId_Revision() { return $this->id_revision; }
	public function setId_Revision($value) { 
		if (is_null($value)) 
			throw new UnexpectedValueException(sprintf("Error en %s.setId_Revision(): no se permiten valores nulos para el atributo 'id_revision'.", get_class($this)));
		if ( (!$this->esInteger($value)) ) 
			throw new InvalidArgumentException(sprintf("Error en %s.setId_Revision(): el atributo 'id_revision' solo permite valores de tipo integer.", get_class($this)));
		$this->id_revision = $value;
		$this->setInstanceState(IS_MODIFIED);
	}
	...
	public function getId_Usuario_Solicitante() { return $this->ro_id_usuario_solicitante; }
	public function setId_Usuario_Solicitante($value) { /* atributo de solo lectura */ }
		...
		$pobservaciones = null)
	{
		...
		$this->ro_id_usuario_solicitante = null;
