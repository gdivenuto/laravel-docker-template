<?php
/**
 * Clase ActuacionExpeElecCaratular
 * 
 * Clase de actuación que se encarga de generar la caratula de un expediente
 * electronico y anexarla (incluye la lógica de recaratulación).
 *
 * NOTA: actualmente la clase no posee persistencia en base de datos.
 * 
 */
class ActuacionExpeElecCaratular extends Actuacion {
	// ************************************************************************
	...
	public function __construct()
	{
		...
		parent::__construct(
			...
			'Caratular un expediente electrónico',
			'Crear la carátula perteneciente a un expediente electrónico.'
		);
		...
		$this->agregarPaso('SeleccionRevisor', [
			'paso_ayuda' => 'Si lo desea, seleccione los revisores que deberán dar su visto bueno antes de generar la carátula.',
		...
		$this->agregarPaso('EditorTexto', [
			...
			'texto_placeholder' => 'Si lo desea, ingrese aquí las observaciones con respecto a la carátula del expediente electrónico.',
