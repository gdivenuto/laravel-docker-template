<?php
/**
 * Clase ActuacionExpeElecPendDescartar
 * 
 * Clase de actuación que modifica descarta un documento electronico pendiente de revision.
 *
 * NOTA: actualmente la clase no posee persistencia en base de datos.
 * 
 */
class ActuacionExpeElecPendDescartar extends Actuacion {
	// ************************************************************************
	...
	public function __construct()
	{
		...
		parent::__construct(
			...
			'Descartar Documento Electrónico Pendiente',
			'Descarta un documento electrónico pendiente de revisión.'
		);
		...
		$this->agregarPaso('DescartarRevision', [
			'permite_preview_documento' => true,
			'documento_a_descartar' => [
				'tipo_documento' => 'directo', 
				'url_base_documento_a_descartar' => URL_KRAKEN_RESOURCES_PROYECTOS,
			]
		]);
		...
		$this->agregarPaso('EditorTexto', [
			...
			'texto_placeholder' => 'Si lo desea, ingrese aquí las observaciones de por qué descarta la revisión del documento pendiente.',
	...
	{
		return [
			'controlador' => 'expedienteselecpend',
			'accion' => 'view',
			'parametros' => []
		];
	}
