<?php
/**
 * Clase ActuacionExpedienteDescartarGiros
 * 
 * Clase de actuación que descarta la carga de Giros a un expediente.
 *
 * NOTA: actualmente la clase no posee persistencia en base de datos.
 * 
 */
class ActuacionExpedienteDescartarGiros extends Actuacion {
	// ************************************************************************
	...
	public function __construct()
	{
		...
		parent::__construct(
			...
			'Descartar Giros para un Expediente',
			'Descarta los giros a comisiones propuestos para un expediente.'
		);
		...
		$this->agregarPaso('EditorTexto', [
			...
			'texto_placeholder' => 'Ingrese aquí el motivo operativo por el cual ha decidido descartar la carga de giros propuestos para el expediente.',
