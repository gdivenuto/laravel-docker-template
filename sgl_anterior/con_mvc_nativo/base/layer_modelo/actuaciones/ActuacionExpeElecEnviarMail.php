<?php
/**
 * Clase ActuacionExpeElecEnviarMail
 * 
 * Clase de actuación que se encarga de enviar un expediente electrónico
 * completo via email, en diferentes formatos.
 *
 * NOTA: actualmente la clase no posee persistencia en base de datos.
 * 
 */
class ActuacionExpeElecEnviarMail extends Actuacion {
	// ************************************************************************
	...
	public function __construct()
	{
		...
		parent::__construct(
			...
			'Compartir un expediente electrónico completo.',
			'Compartir toda la documentación que conforma el expediente electrónico vía correo electrónico, en un único archivo.'
		);
		...
		$this->agregarPaso('SeleccionDestinatarioMail', [
			'paso_nombre' => '',
			'paso_ayuda' => 'Indique los destinatarios con los que desea compartir el documento electrónico seleccionado.',
			'cantidad_minima' => 1,
			'cantidad_maxima' => 10,
		...
		$this->agregarPaso('FormatoExpeElec', [
			'paso_nombre' => '',
			'paso_ayuda' => 'Indique el formato en el que desea compartir el documento electrónico seleccionado.',
		]);
		...
		$this->agregarPaso('EditorTexto', [
			...
			'texto_placeholder' => 'Ingrese aquí el motivo de envío del expediente electrónico.',
