<?php
/**
 * Clase ActuacionExpedienteCargarGiros
 * 
 * Clase de actuación que carga Giros a un expediente y posteriormente
 * carga su providencia.
 *
 * NOTA: actualmente la clase no posee persistencia en base de datos.
 * 
 */
class ActuacionExpedienteCargarGiros extends Actuacion {
	// ************************************************************************
	...
	public function __construct()
	{
		...
		parent::__construct(
			...
			'Cargar Giros para un Expediente',
			'Cargar giros a comisiones para un expediente.'
		);
		...
		$this->agregarPaso('SeleccionComisiones', [
			'paso_ayuda' => 'Seleccione las comisiones a las que se girará el expediente',
			'cantidad_minima' => 0,
		...
		$this->agregarPaso('SeleccionFirmante', [
			'paso_ayuda' => 'Seleccione la autoridad que deberá confirmar los giros a comisión.',
