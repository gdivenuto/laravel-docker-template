<?php
/**
 * Clase ActuacionExpeElecAlcanzarDec1404
 * 
 * Clase de actuación que se encarga de indicar si una entrada del expediente
 * electronico es alcanzada o no por el Art. 11 Dec. 1404.
 *
 * NOTA: actualmente la clase no posee persistencia en base de datos.
 * 
 */
class ActuacionExpeElecAlcanzarDec1404 extends Actuacion {
	// ************************************************************************
	...
	public function __construct()
	{
		...
		parent::__construct(
			...
			'Determinar el alcance del Art. 11 Decreto 1.404',
			'Determinar si una entrada del expediente electrónico es alcanzada por el Art. 11 Decreto 1.404.'
		);
		...
		$this->agregarPaso('ConfirmarDec1404', [
			...
			'documento_a_confirmar' => [
				...
				'url_base_documento_a_confirmar' => URL_KRAKEN_RESOURCES_PROYECTOS,
			]
		]);
		...
		$this->agregarPaso('EditorTexto', [
			...
			'texto_placeholder' => 'Si lo desea, ingrese aquí el motivo del cambio del alcance del Art. 11 Decreto 1.404.',
