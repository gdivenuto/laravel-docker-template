<?php
/**
 * Clase ActuacionExpedienteConvalidarGiros
 * 
 * Clase de actuación que convalida los Giros de un expediente.
 *
 * NOTA: actualmente la clase no posee persistencia en base de datos.
 * 
 */
class ActuacionExpedienteConvalidarGiros extends Actuacion {
	// ************************************************************************
	...
	public function __construct()
	{
		...
		parent::__construct(
			...
			'Convalidar Giros para un Expediente',
			'Convalidar giros a comisiones para un expediente.'
		);
		...
		$this->agregarPaso('SeleccionComisiones', [
			'paso_ayuda' => 'Confirme las comisiones del expediente a convalidar.',
			'generar_providencia_pdf' => [
				'generar_providencia' => true,
				'tipo_providencia' => 'convalidar_giros',
		...
		$this->agregarPaso('SeleccionFirmante', [
			'paso_ayuda' => 'Seleccione la autoridad que deberá convalidar los giros a comisión.',
			'tipo_firmantes' => 'giros',
			'cantidad_minima' => 1,
			'cantidad_maxima' => 1,
			'firmantes_default' => [SGL_ID_USUARIO_FIRMANTE_GIROS_DEFAULT],
			'excluir_usuario_actual' => false
		]);
