<?php
/**
 * Clase ExpedienteElecPend
 * 
 * Descripción: expe_expedientes_elec_pend 
 * Layer Datos: DBExpedientesElecPend
 * Layer Negocio: NGExpedientesElecPend
 *
 * GenerateClass 0.97.7 beta @ 2022-11-16 12:10:39
 */
class ExpedienteElecPend extends ClaseBase {
	// ************************************************************************
	...
	protected $ro_total_revisiones; // Asociado a las revisiones del documento
	protected $ro_cant_confirmados; // Asociado a las revisiones del documento
	protected $ro_cant_pendientes;  // Asociado a las revisiones del documento
	protected $ro_cant_rechazados;  // Asociado a las revisiones del documento
	protected $ro_cant_descartados; // Asociado a las revisiones del documento
	...
	public function getTotal_Revisiones() { return $this->ro_total_revisiones; }
	public function setTotal_Revisiones($value) { /* atributo de solo lectura */ }

	public function getCant_Confirmados() { return $this->ro_cant_confirmados; }
	public function setCant_Confirmados($value) { /* atributo de solo lectura */ }
	...
	public function getCant_Rechazados() { return $this->ro_cant_rechazados; }
	public function setCant_Rechazados($value) { /* atributo de solo lectura */ }

	public function getCant_Descartados() { return $this->ro_cant_descartados; }
	public function setCant_Descartados($value) { /* atributo de solo lectura */ }
		...
		$pobservaciones = null)
	{
		...
		$this->ro_total_revisiones = 0;
		$this->ro_cant_confirmados = 0;
		$this->ro_cant_pendientes = 0;
		$this->ro_cant_rechazados = 0;
		$this->ro_cant_descartados = 0;
	...
	/**
	 * Devuelve la etiqueta de un documento del expediente electrónico pendiente.
	...
	/**
	 * Determina si todas las revisiones han sido completadas (confirmadas, rechazadas y descartadas).
	 * @return [type] [description]
	 */
	public function sinRevisionesPendientes()
	{
		return $this->total_revisiones == ($this->cant_confirmados + $this->cant_rechazados + $this->cant_descartados);
	}

	/**
	 * Determina si alguna de las revisiones han sido rechazadas.
	 * @return [type] [description]
	 */
	public function hayRevisionesRechazadas()
	{
		return $this->cant_rechazados > 0;
	}

	/**
	 * Determina si alguna de las revisiones han sido descartadas.
	 * @return [type] [description]
	 */
	public function hayRevisionesDescartadas()
	{
		return $this->cant_descartados > 0;
	}	
}
?>