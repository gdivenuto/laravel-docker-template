<?php
/**
 * Capa de negocio para funcionalidad de ActuacionDocumentoComponerFirmarPdf.
 *
 * @author XXXX, XXXX
 *
 */
class NGActuacionDocumentoComponerFirmarPdf extends NGActuacionBase {
	...
	public function procesarActuacion(Actuacion $actuacion, Usuario $pUsuario = null)
	{
		...
		// Paso 3: Destinatarios del Documento
		...
		$archivo_firmado = sprintf('%sdocumento_%s_%s.pdf',
			$actuacion->pasos[2]->opciones['path_documento_firmado'],
		...
		$actuacion->info_auditoria = [
			...
			'Texto' => strip_tags($texto_original),
