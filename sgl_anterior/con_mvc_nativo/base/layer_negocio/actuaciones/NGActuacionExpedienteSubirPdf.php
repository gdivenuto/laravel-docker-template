<?php
/**
 * Capa de negocio para funcionalidad de ActuacionExpedienteSubirPdf.
 *
 * @author XXXX, XXXX
 *
 */
class NGActuacionExpedienteSubirPdf extends NGActuacionBase {
