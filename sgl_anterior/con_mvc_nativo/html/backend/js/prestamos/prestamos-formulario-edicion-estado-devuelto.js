...
var listenerBotonGuardar = function () {
    ...
    if (formEdicionPrestamo.valid()) {
        ...
        $.ajax({
            ...
            url: "index.php?c=prestamos&a=save&f_grilla="+$('#f_grilla').val()+"&f_nuevo_estado=D&f_nueva_fecha_hora="+$('#f_nueva_fecha').val()+'%20'+$('#f_nueva_hora').val(),
            dataType: 'json', 
...
$(document).ready(function () {
    ...
    formEdicionPrestamo.validate({
        ...
        messages: {
                f_v_nueva_fecha: { 
                    required: "Debe especificar la fecha que se devuelve el pr&eacute;stamo."
                }
            },
