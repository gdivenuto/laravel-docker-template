...
var listenerBotonGuardar = function () {
    ...
    if (formEdicionPrestamo.valid()) {
        ...
        $.ajax({
            ...
            url: "index.php?c=prestamos&a=save&f_grilla="+$('#f_grilla').val()+"&f_editarsoloinfo=1",
            dataType: 'json', 
...
{
    prestamo.libro_numero = ($('#f_libro_numero')) ? $('#f_libro_numero').val() : '';
    prestamo.libro_folio  = ($('#f_libro_folio')) ? $('#f_libro_folio').val() : '';
