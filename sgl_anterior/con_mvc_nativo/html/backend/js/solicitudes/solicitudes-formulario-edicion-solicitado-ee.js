...
var listenerBotonGuardar = function () {
    ...
    if (formEdicionSolicitud.valid()) {
        ...
        $.ajax({
            ...
            url: "index.php?c=solicitudes&a=save&f_nuevo_estado=SEE&f_nueva_fecha_hora="+$('#f_nueva_fecha').val()+'%20'+$('#f_nueva_hora').val(),
            dataType: 'json', 
        ...
        .done(function( respuesta ) {
            if (respuesta.estado == 'OK') {
                if (respuesta.data != null) {
                    // Se muestra la grilla con la Solicitud editada
