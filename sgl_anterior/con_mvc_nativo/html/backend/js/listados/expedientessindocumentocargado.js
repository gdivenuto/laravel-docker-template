...
var callbackRenderFichas = function (data, type, full, meta) {
    ...
    if (full != null && full.estado_proyecto === 'SC' )
    {
        if (full.tipo == 'E') {
...
var listenerBotonRefrescar = function () {
    ...
    $(location).attr('href','index.php?c=listadoexpedientessindocumentocargado&a=view&f_restablecer=1');
};
...
$(document).ready(function () {
    ...
    $('#btn_buscar').click(function () {
        ...
        if (formBusquedaRef.valid()) {
            dataTableRef = setDataTable('index.php?c=listadoexpedientessindocumentocargado&a=expedientessindocumentocargadodatagrid');
    ...
    $('#btn_imprimir').click(function () { 
        ...
        if (formBusquedaRef.valid()) {
            ...
            var url = 'index.php?c=listadoexpedientessindocumentocargado&a=generarpdfsindocumentocargado&f_fecha_desde={0}&f_fecha_hasta={1}'.format(
                $('#f_fecha_desde').val(),
                $('#f_fecha_hasta').val()
            );
            // Se muestra el pdf en una nueva pestaña
    ...
    $('#btn_exportar_texto').click(function () { 
        ...
        if (formBusquedaRef.valid()) {
            ...
            $(location).attr('href','index.php?c=listadoexpedientessindocumentocargado&a=generardocumentotextosindocumentocargado&f_fecha_desde={0}&f_fecha_hasta={1}'.format(
                $('#f_fecha_desde').val(),
                $('#f_fecha_hasta').val())
            );
        }
    ...
    formBusquedaRef = $("#form_sin_documento_cargado");
