...
var listenerBotonRefrescar = function () {
    // Se redirecciona a la grilla restableciendo los filtros
    $(location).attr('href','index.php?c=listadoexpedientesparaexpurgo&a=view&f_restablecer=1');
};
...
$(document).ready(function () {
    ...
    $('#btn_buscar').click(function () {
        ...
        if (formBusquedaRef.valid()) {
            ...
            if ( $('#f_estado').val() == 0 )
                ...
                dataTableRef = setDataTable('index.php?c=listadoexpedientesparaexpurgo&a=expedientesparaexpurgodatagrid');
    ...
    $('#btn_imprimir').click(function () { 
        ...
        if (formBusquedaRef.valid()) {
            ...
            var url = 'index.php?c=listadoexpedientesparaexpurgo&a=generarpdfexpedientesparaexpurgo&f_fecha_desde={0}&f_fecha_hasta={1}&f_estado={2}'.format(
                $('#f_fecha_desde').val(),
                $('#f_fecha_hasta').val(),
                $('#f_estado').val()
            );
    ...
    $('#btn_exportar_texto').click(function () { 
        ...
        if (formBusquedaRef.valid()) {
            // Se genera el PDF del reporte de Expedientes en Comisión
            $(location).attr('href','index.php?c=listadoexpedientesparaexpurgo&a=generardocumentotextoexpedientesparaexpurgo&f_fecha_desde={0}&f_fecha_hasta={1}&f_estado={2}'.format(
                $('#f_fecha_desde').val(),
                $('#f_fecha_hasta').val(),
                $('#f_estado').val())
            );
    ...
    $('#btn_exportar_planilla').click(function () { 
        ...
        if (formBusquedaRef.valid()) {
            // Se genera el PDF del reporte de Expedientes en Comisión
            $(location).attr('href','index.php?c=listadoexpedientesparaexpurgo&a=generarplanillaexpedientesparaexpurgo&f_fecha_desde={0}&f_fecha_hasta={1}&f_estado={2}'.format(
                $('#f_fecha_desde').val(),
                $('#f_fecha_hasta').val(),
                $('#f_estado').val())
            );
    ...
    formBusquedaRef = $("#form_expedientes_para_expurgo");
