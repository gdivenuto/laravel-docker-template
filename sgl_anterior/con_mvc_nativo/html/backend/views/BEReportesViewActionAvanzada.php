 ...
 */
class BEReportesViewActionAvanzada extends BaseViewActionReport {
	// ************************************************************************
	...
	public function __construct(BaseView $view) {
		...
		$this->vista->dataTitulo = 'B&uacute;squeda Avanzada de Expedientes';
	}
	...
	public function generarHtmlHeaderCSS() {
		...
		// Se incluye el CSS específico para este reporte
		echo '<link rel="stylesheet" type="text/css" href="' . $this->vista->baseUrl . 'css/estilo_reporte_avanzada.css" />' . "\n";
	}
	...
	public function generarCuerpo() {
		...
		require $this->vista->baseTemplatePath . 'reportes/reporte_busqueda_avanzada.php';
	}
