 ...
 */
class BEDocumentoTextoViewActionDetalleDeGiros extends BaseViewActionDocumentoTexto {
	// ************************************************************************
	...
	public function generarCabecera()
	{
		...
		require($this->vista->baseTemplatePath.'documentos_texto/cabeceras/cabecera_detalle_de_giros.php');
	}
	...
	{
		require($this->vista->baseTemplatePath.'documentos_texto/documento_texto_detalle_de_giros.php');
	}
