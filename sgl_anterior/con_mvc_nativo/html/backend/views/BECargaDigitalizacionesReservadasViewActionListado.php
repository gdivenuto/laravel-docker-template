 ...
 */
class BECargaDigitalizacionesReservadasViewActionListado extends BaseViewActionGrid {
	// ************************************************************************
	...
	public function generarHtmlHeaderJS() {
		...
		// Agrego su propio JS
		echo '<script type="text/javascript" src="' . $this->vista->baseUrl . 'js/carga_digitalizaciones_reservadas/carga-digitalizaciones-reservadas-listado.js?v='.SGL_BUILD_NUMBER.'"></script>' . "\n";
	}
	...
	public function generarCuerpo() {
		...
		require $this->vista->baseTemplatePath . 'carga_digitalizacion_reservada/carga_digitalizacion_reservada_cuerpo_listado.php';
	}
