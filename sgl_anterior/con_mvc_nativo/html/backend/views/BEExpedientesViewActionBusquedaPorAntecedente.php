 ...
 */
class BEExpedientesViewActionBusquedaPorAntecedente extends BaseViewActionGrid {
	// ************************************************************************
	...
	public function generarHtmlHeaderJS()
	{
		...
		// Agrego su propio JS
		echo '<script type="text/javascript" src="'.$this->vista->baseUrl.'js/expedientes/expedientes-busquedaporantecedente.js?v='.SGL_BUILD_NUMBER.'"></script>'."\n";
	}
	...
	public function generarCuerpo()
	{
		...
		require($this->vista->baseTemplatePath.'expedientes/expedientes_cuerpo_busqueda_por_antecedentes.php');
	}
