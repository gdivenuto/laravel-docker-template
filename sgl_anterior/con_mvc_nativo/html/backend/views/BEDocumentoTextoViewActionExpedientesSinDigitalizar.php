 ...
 */
class BEDocumentoTextoViewActionExpedientesSinDigitalizar extends BaseViewActionDocumentoTexto {
	// ************************************************************************
	...
	public function generarCabecera()
	{
		...
		require($this->vista->baseTemplatePath.'documentos_texto/cabeceras/cabecera_expedientes_sin_digitalizar.php');
	}
	...
	{
		require($this->vista->baseTemplatePath.'documentos_texto/documento_texto_expedientes_sin_digitalizar.php');
	}
