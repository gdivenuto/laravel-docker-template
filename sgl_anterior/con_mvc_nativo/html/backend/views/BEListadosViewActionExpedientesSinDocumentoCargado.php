 ...
 */
class BEListadosViewActionExpedientesSinDocumentoCargado extends BaseViewActionGrid {
	// ************************************************************************
	...
	public function generarHtmlHeaderJS()
	{
		...
		// Agregamos las siguientes líneas porque se requiere el datePicker para los calendarios
		...
		// Agrego su propio JS
		echo '<script type="text/javascript" src="'.$this->vista->baseUrl.'js/listados/expedientessindocumentocargado.js?v='.SGL_BUILD_NUMBER.'"></script>'."\n";
	}
	...
	public function generarCuerpo()
	{
		...
		require($this->vista->baseTemplatePath.'listados/expedientessindocumentocargado.php');
	}
