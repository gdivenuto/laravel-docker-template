<?php
/**
 * Vista de Firmas Pendientes para los Supervisores.
 ...
 *
 */
class BEFirmasPendientesParaSupervisorView extends BaseView {
	...
	/**
	 * Vista por defecto para el listado de Firmas pendientes para los supervisores.
	 * Ejecuta la acción BEFirmasPendientesParaSupervisorViewActionGrilla.
	 */
	public function vistaPendientesFirma() {
		$this->accionVista = new BEFirmasPendientesParaSupervisorViewActionGrilla($this);
