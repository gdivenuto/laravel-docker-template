 ...
 */
class BEExpedientesViewActionBusquedaAvanzada extends BaseViewActionGrid {
	// ************************************************************************
	...
	public function generarHtmlHeaderJS()
	{
		...
		// Agregamos las siguientes líneas porque se requiere el datePicker en la Búsqueda Avanzada
		echo '<!-- jQueryUI DatePicker -->'."\n";
		echo '<link rel="stylesheet" type="text/css" href="'.URL_KRAKEN_HTML_LIBRERIAS.'jquery-ui-custom/jquery-ui.min.css">'."\n";
		echo '<script type="text/javascript" src="'.URL_KRAKEN_HTML_LIBRERIAS.'jquery-ui-custom/jquery-ui.min.js"></script>'."\n";
		echo '<script type="text/javascript" src="'.URL_KRAKEN_HTML_LIBRERIAS.'jquery-ui-custom/i18n/datepicker-es.js"></script>'."\n";
		
		// Agrego su propio JS
		echo '<script type="text/javascript" src="'.$this->vista->baseUrl.'js/expedientes/expedientes-busquedaavanzada.js?v='.SGL_BUILD_NUMBER.'"></script>'."\n";
	}
	...
	public function generarHtmlHeaderCSS()
	{
		...
		// Se incluye el CSS propio para los Listados
		echo '<link href="'.$this->vista->baseUrl.'css/listados/listados.css" rel="stylesheet" type="text/css" />';
	}
	...
	public function generarCuerpo()
	{
		...
		require($this->vista->baseTemplatePath.'expedientes/expedientes_cuerpo_busqueda_avanzada.php');
	}
