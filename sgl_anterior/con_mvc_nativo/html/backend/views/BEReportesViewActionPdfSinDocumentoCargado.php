 ...
 */
class BEReportesViewActionPdfSinDocumentoCargado extends BaseViewActionReport {
	// ************************************************************************
	...
	public function __construct(BaseView $view) {
		...
		$this->vista->dataTitulo = 'Expedientes sin documento cargado';
	}
	...
	public function generarCuerpo()
	{
		...
		require($this->vista->baseTemplatePath.'reportes/reporte_pdf_sin_documento_cargado.php');
	}
