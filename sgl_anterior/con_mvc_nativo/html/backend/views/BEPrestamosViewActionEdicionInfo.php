 ...
 */
class BEPrestamosViewActionEdicionInfo extends BaseViewActionForm {
	// ************************************************************************
	...
	public function generarHtmlHeaderJS()
	{
		...
		// Agrego su propio JS
		echo '<script type="text/javascript" src="'.$this->vista->baseUrl.'js/prestamos/prestamos-formulario-edicion-info.js?v='.SGL_BUILD_NUMBER.'"></script>'."\n";
	}
	...
	public function generarCuerpo()
	{
		...
		require($this->vista->baseTemplatePath.'prestamos/prestamos_cuerpo_formulario_edicion_info.php');
	}
