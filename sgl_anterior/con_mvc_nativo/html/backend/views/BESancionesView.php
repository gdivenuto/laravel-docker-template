 ...
 *
 */
class BESancionesView extends BaseView {
	...
	/**
	 * Vista por defecto para el listado de Sanciones de un expediente determinado.
	 * Ejecuta la acción BESancionesViewActionListado.
	 */
	public function vistaListado() {
		$this->accionVista = new BESancionesViewActionGrilla($this);
		$this->accionVista->entregar('base.php');
	}

	/**
	 * Vista por defecto para el formulario de edición de la Sanción.
	 * Ejecuta la acción BESancionesViewActionEdicion.
	 */
	public function vistaEdicion() {
		$this->accionVista = new BESancionesViewActionEdicion($this);
		$this->accionVista->entregar('base.php');
	}
}
?>
