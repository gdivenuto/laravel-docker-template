 ...
 *
 */
class BEGirosView extends BaseView {
	 ...
	 * Ejecuta la acción BEGirosViewActionGrilla.
	 */
	public function vistaListado() {
		$this->accionVista = new BEGirosViewActionGrilla($this);
		$this->accionVista->entregar('base.php');
	}

	/**
	 * Vista por defecto para el formulario de edición del Giro.
	 * Ejecuta la acción BEGirosViewActionEdicion.
	 */
	public function vistaEdicion() {
		$this->accionVista = new BEGirosViewActionEdicion($this);
		$this->accionVista->entregar('base.php');
	}
}
?>
