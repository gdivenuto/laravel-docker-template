 ...
 */
class BEPlanillaCalculoViewActionBusquedaAvanzada extends BaseViewActionPlanillaCalculo {
	// ************************************************************************
	...
	public function generarCabecera()
	{
		...
		require($this->vista->baseTemplatePath.'planillas_calculo/cabeceras/cabecera_busqueda_avanzada.php');
	}
	...
	{
		require($this->vista->baseTemplatePath.'planillas_calculo/planilla_calculo_busqueda_avanzada.php');
	}
}
?>