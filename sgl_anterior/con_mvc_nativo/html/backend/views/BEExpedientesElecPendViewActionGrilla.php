 ...
 */
class BEExpedientesElecPendViewActionGrilla extends BaseViewActionGrid {
	// ************************************************************************
	...
	public function generarHtmlHeaderJS()
	{
		...
		// Agrego su propio JS
		echo '<script type="text/javascript" src="'.$this->vista->baseUrl.'js/expedientes_elec_pend/expedientes-elec-pend-grilla.js?v='.SGL_BUILD_NUMBER.'"></script>'."\n";
	}
	...
	public function generarCuerpo()
	{
		...
		require($this->vista->baseTemplatePath.'expedientes_elec_pend/expedientes_elec_pend_cuerpo_grilla.php');
	}
