<?php
/**
 * Vista que renderiza el fomulario de seleccion de revisores para la confección de un documento
 * 
 ...
 */
class BEPASeleccionRevisorViewActionEdicion extends BEPABaseViewActionForm {
	// ************************************************************************
	...
	public function generarHtmlHeaderJS()
	{
		...
		// Agrego su propio JS
		echo '<script type="text/javascript" src="'.$this->vista->baseUrl.'js/actuaciones/paso_seleccion_revisor.js?v='.SGL_BUILD_NUMBER.'"></script>'."\n";
	}
	...
	public function generarCuerpo()
	{
		...
		require($this->vista->baseTemplatePath.'actuaciones/seleccion_revisor_cuerpo.php');
	}
