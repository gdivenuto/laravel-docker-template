<?php
/**
 * Vista que renderiza el fomulario de seleccion de comisiones para el giro de un expediente
 * 
 ...
 */
class BEPASeleccionComisionesViewActionEdicion extends BEPABaseViewActionForm {
	// ************************************************************************
	...
	public function generarHtmlHeaderJS()
	{
		...
		// Agrego su propio JS
		echo '<script type="text/javascript" src="'.$this->vista->baseUrl.'js/actuaciones/paso_seleccion_comisiones.js?v='.SGL_BUILD_NUMBER.'"></script>'."\n";
	}
	...
	public function generarCuerpo()
	{
		...
		require($this->vista->baseTemplatePath.'actuaciones/seleccion_comisiones_cuerpo.php');
	}
