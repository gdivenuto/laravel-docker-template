<?php
/**
 * Vista que renderiza un formulario de seleccion de formato del expediente electronico a descargar.
 * 
 ...
 */
class BEPAFormatoExpeElecViewActionEdicion extends BEPABaseViewActionForm {
	// ************************************************************************
	...
	public function generarHtmlHeaderJS()
	{
		...
		// Agrego su propio JS
		echo '<script type="text/javascript" src="'.$this->vista->baseUrl.'js/actuaciones/paso_formato_expe_elec.js?v='.SGL_BUILD_NUMBER.'"></script>'."\n";
	}
	...
	public function generarCuerpo()
	{
		...
		require($this->vista->baseTemplatePath.'actuaciones/formato_expe_elec_cuerpo.php');
	}
