<?php
/**
 * Vista del Paso para llevar a cabo la subida de un archivo.
 *
 ...
 *
 */
class BEPASubirArchivoView extends BEPABaseView {
	...
	/**
	 * Ejecuta la acción BEPASubirArchivoViewActionEdicion.
	 */
	public function vistaPasoActuacion()
	{
		parent::vistaPasoActuacion();

		$this->accionVista = new BEPASubirArchivoViewActionEdicion($this);
