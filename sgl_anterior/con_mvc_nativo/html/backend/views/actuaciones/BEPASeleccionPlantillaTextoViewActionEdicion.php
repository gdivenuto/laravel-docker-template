<?php
/**
 * Vista que renderiza el fomulario de seleccion de una plantilla de texto.
 * 
 ...
 */
class BEPASeleccionPlantillaTextoViewActionEdicion extends BEPABaseViewActionForm {
	// ************************************************************************
	...
	public function generarHtmlHeaderJS()
	{
		...
		// Agrego su propio JS
		echo '<script type="text/javascript" src="'.$this->vista->baseUrl.'js/actuaciones/paso_seleccion_plantilla_texto.js?v='.SGL_BUILD_NUMBER.'"></script>'."\n";
	}
	...
	public function generarCuerpo()
	{
		...
		require($this->vista->baseTemplatePath.'actuaciones/seleccion_plantilla_texto_cuerpo.php');
	}
