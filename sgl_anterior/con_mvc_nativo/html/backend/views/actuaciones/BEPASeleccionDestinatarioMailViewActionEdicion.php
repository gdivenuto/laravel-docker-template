<?php
/**
 * Vista que renderiza el fomulario de notificacion por mail para la confección de un documento
 * 
 ...
 */
class BEPASeleccionDestinatarioMailViewActionEdicion extends BEPABaseViewActionForm {
	// ************************************************************************
	...
	public function generarHtmlHeaderJS()
	{
		...
		// Agrego su propio JS
		echo '<script type="text/javascript" src="'.$this->vista->baseUrl.'js/actuaciones/paso_seleccion_destinatario_mail.js?v='.SGL_BUILD_NUMBER.'"></script>'."\n";
	}
	...
	public function generarCuerpo()
	{
		...
		require($this->vista->baseTemplatePath.'actuaciones/seleccion_destinatario_mail_cuerpo.php');
	}
