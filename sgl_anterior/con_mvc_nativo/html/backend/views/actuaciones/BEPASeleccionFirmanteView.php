<?php
/**
 * Vista del Paso para la Selección del Firmante.
 *
 ...
 *
 */
class BEPASeleccionFirmanteView extends BEPABaseView {
	 ...
	 * Ejecuta la acción BEPASeleccionFirmanteViewActionEdicion.
	 */
	public function vistaPasoActuacion()
	{
		parent::vistaPasoActuacion();

		$this->accionVista = new BEPASeleccionFirmanteViewActionEdicion($this);
