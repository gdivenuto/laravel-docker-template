<?php
/**
 * Vista de CargaDigitalizaciones.
 ...
 *
 */
class BECargaDigitalizacionesView extends BaseView {
	...
	/**
	 * Vista para el listado del contenido del directorio resources/proyectos/digital/
	 * Ejecuta la acción BECargaDigitalizacionesViewActionListado.
	 */
	public function vistaListado() {
		$this->accionVista = new BECargaDigitalizacionesViewActionListado($this);
