 ...
 */
class BEPrestamosViewActionGrillaGeneral extends BaseViewActionGrid {
	// ************************************************************************
	...
	public function generarHtmlHeaderJS()
	{
		...
		// Para el idioma español de los calendarios
		...
		// Agrego un JS general para todas las solapas de búsqueda simple
		echo '<script type="text/javascript" src="'.$this->vista->baseUrl.'js/expedientes/expedientes-busquedasimple-common.js?v='.SGL_BUILD_NUMBER.'"></script>'."\n";

		// Agrego su propio JS
		echo '<script type="text/javascript" src="'.$this->vista->baseUrl.'js/prestamos/prestamos-grilla-general.js?v='.SGL_BUILD_NUMBER.'"></script>'."\n";
	}
	...
	public function generarCuerpo()
	{
		...
		require($this->vista->baseTemplatePath.'prestamos/prestamos_cuerpo_grilla_general.php');
	}
