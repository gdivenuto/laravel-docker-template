 ...
 */
class BEDocumentoTextoViewActionAsuntosEntrados extends BaseViewActionDocumentoTexto {
	// ************************************************************************
	...
	public function generarCabecera()
	{
		...
		require($this->vista->baseTemplatePath.'documentos_texto/cabeceras/cabecera_asuntos_entrados.php');
	}
	...
	{
		require($this->vista->baseTemplatePath.'documentos_texto/documento_texto_asuntos_entrados.php');
	}
