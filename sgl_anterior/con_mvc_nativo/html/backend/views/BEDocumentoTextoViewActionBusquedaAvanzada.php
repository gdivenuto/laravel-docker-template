 ...
 */
class BEDocumentoTextoViewActionBusquedaAvanzada extends BaseViewActionDocumentoTexto {
	// ************************************************************************
	...
	public function generarCabecera()
	{
		...
		require($this->vista->baseTemplatePath.'documentos_texto/cabeceras/cabecera_busqueda_avanzada.php');
	}
	...
	{
		require($this->vista->baseTemplatePath.'documentos_texto/documento_texto_busqueda_avanzada.php');
	}
