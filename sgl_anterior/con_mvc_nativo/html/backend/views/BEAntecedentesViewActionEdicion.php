 ...
 */
class BEAntecedentesViewActionEdicion extends BaseViewActionForm {
	// ************************************************************************
	...
	public function generarHtmlHeaderJS()
	{
		...
		// Agrego su propio JS
		echo '<script type="text/javascript" src="'.$this->vista->baseUrl.'js/antecedentes/antecedentes-formulario-edicion.js?v='.SGL_BUILD_NUMBER.'"></script>'."\n";
	}
	...
	public function generarCuerpo()
	{
		...
		require($this->vista->baseTemplatePath.'antecedentes/antecedentes_cuerpo_formulario_edicion.php');
	}
