 ...
 */
class BEMarcaComisionViewActionListado extends BaseViewActionGrid {
	// ************************************************************************
	...
	public function generarHtmlHeaderJS()
	{
		...
		// Agrego su propio JS
		echo '<script type="text/javascript" src="'.$this->vista->baseUrl.'js/marca_comision/listado.js?v='.SGL_BUILD_NUMBER.'"></script>'."\n";
	}
	...
	public function generarHtmlHeaderCSS()
	{
		...
		// Se incluye el CSS propio para Marca de Expedientes en Comisión
		echo '<link href="'.$this->vista->baseUrl.'css/marca_comision/marca_comision.css" rel="stylesheet" type="text/css" />';
	}
	...
	public function generarCuerpo()
	{
		...
		require($this->vista->baseTemplatePath.'marca_comision/listado.php');
	}
