 ...
 */
class BESancionesViewActionGrilla extends BaseViewActionGrid {
	// ************************************************************************
	...
	public function generarHtmlHeaderJS()
	{
		...
		// Agrego su propio JS
		echo '<script type="text/javascript" src="'.$this->vista->baseUrl.'js/sanciones/sanciones-grilla.js?v='.SGL_BUILD_NUMBER.'"></script>'."\n";
	}
	...
	public function generarCuerpo()
	{
		...
		require($this->vista->baseTemplatePath.'sanciones/sanciones_cuerpo_grilla.php');
	}
