 ...
 */
class BEDocumentoTextoViewActionExpedientesEnPrestamo extends BaseViewActionDocumentoTexto {
	// ************************************************************************
	...
	public function generarCabecera()
	{
		...
		require($this->vista->baseTemplatePath.'documentos_texto/cabeceras/cabecera_expedientes_en_prestamo.php');
	}
	...
	{
		require($this->vista->baseTemplatePath.'documentos_texto/documento_texto_expedientes_en_prestamo.php');
	}
