 ...
 */
class BECargaDigitalizacionesViewActionListado extends BaseViewActionGrid {
	// ************************************************************************
	...
	public function generarHtmlHeaderJS()
	{
		...
		// Agrego su propio JS
		echo '<script type="text/javascript" src="'.$this->vista->baseUrl.'js/carga_digitalizaciones/carga-digitalizaciones-listado.js?v='.SGL_BUILD_NUMBER.'"></script>'."\n";
	}
	...
	public function generarCuerpo()
	{
		...
		require($this->vista->baseTemplatePath.'carga_digitalizacion/carga_digitalizacion_cuerpo_listado.php');
	}
