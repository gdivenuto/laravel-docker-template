 ...
 */
class BEAntecedentesViewActionMostrarDocumentosDE extends BaseViewActionGrid {
	// ************************************************************************
	...
	public function generarHtmlHeaderJS()
	{
		...
		// Agrego su propio JS
		echo '<script type="text/javascript" src="'.$this->vista->baseUrl.'js/carga_documentos_depto_ejecutivo/carga_documentos_depto_ejecutivo_listado.js?v='.SGL_BUILD_NUMBER.'"></script>'."\n";
	}
	...
	public function generarCuerpo()
	{
		...
		require($this->vista->baseTemplatePath.'carga_documentos_depto_ejecutivo/documentos_depto_ejecutivo_cuerpo_listado.php');
	}
