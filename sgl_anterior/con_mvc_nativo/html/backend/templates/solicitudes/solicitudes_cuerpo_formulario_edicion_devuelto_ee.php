...
$f_generar_nueva_solicitud = $this->vista->data['f_generar_nueva_solicitud'];
...
<div class="row borde-inferior">
    <div class="col-md-12">
        <h4><span class="glyphicon glyphicon-edit"></span>&nbsp;<b>Devolver</b> al Ente Externo el Expediente <?php echo $solicitud->anio.'-'.$solicitud->tipo.'-'.$solicitud->numero.'-'.$solicitud->cuerpo.'-'.$solicitud->alcance; ?></h4>
    </div>
</div>
<form id="formEdicionSolicitud" name="formEdicionSolicitud" class="form-horizontal" role="form">
  
    <input type="hidden" id="f_generar_nueva_solicitud" name="f_generar_nueva_solicitud" value="<?php echo $f_generar_nueva_solicitud; ?>" />
