...
<div class="row borde-inferior">
    <div class="col-md-12">
        <h4><span class="glyphicon glyphicon-edit"></span>&nbsp;<b>Ingresar</b> al HCD el Expediente <?php echo $solicitud->anio.'-'.$solicitud->tipo.'-'.$solicitud->numero.'-'.$solicitud->cuerpo.'-'.$solicitud->alcance; ?></h4>
    </div>
</div>
