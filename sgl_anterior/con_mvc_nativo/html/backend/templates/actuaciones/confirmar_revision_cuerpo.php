...
<form   id="formPasoActuacion" name="formPasoActuacion" 
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            ?>
                <h3>¿Desea <u>confirmar y firmar</u> o <u>rechazar</u> el documento pendiente?</h3>
                <p>Debido a que <strong>usted es el único revisor y firmante, puede resolver ambos pasos</strong> en una única actuación.</p>
                <div class="radio">
                    <label>
                        <input type="radio" id="op_revision_si" name="f_op_revision" class="op_revision" value="1">&nbsp;Deseo <strong>confirmar y firmar</strong> el documento pendiente.
                    </label>
                </div>
                <div class="radio">
                    <label>
                        <input type="radio" id="op_revision_no" name="f_op_revision" class="op_revision" value="0">&nbsp;Deseo <strong>rechazar</strong> el documento pendiente.
                    </label>
                </div>            
            <?php
                } else {
            ?>
                <h3>¿Desea <u>confirmar</u> o <u>rechazar</u> el documento pendiente?</h3>
                <div class="radio">
                    <label>
                        <input type="radio" id="op_revision_si" name="f_op_revision" class="op_revision" value="1">&nbsp;Deseo <strong>confirmar</strong> el documento pendiente.
                    </label>
                </div>
                <div class="radio">
                    <label>
