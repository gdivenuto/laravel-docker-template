...
<form id="formPasoActuacion" name="formPasoActuacion" method="POST"
    ...
    <select multiple id="f_comisiones" name="f_comisiones[]" class="display_none"></select>
    <select multiple id="f_observaciones" name="f_observaciones[]" class="display_none"></select>

    <div id="fila_chk_ppc" class="row">
        <div class="col-md-12">
            <div class="checkbox">
                <label class="control-label">
                    <input type="checkbox" id="f_ppc" name="f_ppc" value="1" />
                    &nbsp;<strong>Para considerar Participaci&oacute;n Ciudadana</strong>
                </label>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-5 margen_x_10">
            <h3><strong>Comisiones disponibles</strong></h3>
            ...
            <br>
            <div id="lista_comisiones_disponibles" class="row scroll_vertical_auto listas_firmantes">
            </div>
        </div>
        <div class="col-md-6 margen_x_10">
            <h3 class="margen_sup_23"><strong>Comisiones seleccionadas</strong></h3>
            ...
            <div id="lista_comisiones" class="row scroll_vertical_auto listas_firmantes margen_sup_20">
            </div>
        </div>
    </div>
</form>
