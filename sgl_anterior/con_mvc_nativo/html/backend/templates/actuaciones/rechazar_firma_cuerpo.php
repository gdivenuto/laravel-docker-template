...
<form   id="formPasoActuacion" name="formPasoActuacion" 
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <h3>¿Desea rechazar la solicitud de firma digital del documento?</h3>
            <div class="radio">
                <label>
                    <input type="radio" id="op_confirmacion_si" name="f_op_confirmacion" value="1" class="op_confirmacion">&nbsp;S&iacute;, deseo rechazar la solicitud de firma digital del documento.
                </label>
            </div>
            <div class="radio">
                <label>
                    <input type="radio" id="op_confirmacion_no" name="f_op_confirmacion" value="0" class="op_confirmacion">&nbsp;No, no tengo intenci&oacute;n de rechazar la solicitud de firma digital del documento.
                </label>
            </div>
        </div>
