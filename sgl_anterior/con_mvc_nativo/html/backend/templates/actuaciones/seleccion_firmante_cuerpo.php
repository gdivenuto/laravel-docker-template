...
<form id="formPasoActuacion" name="formPasoActuacion" method="POST"
    ...
    <select multiple id="f_firmantes" name="f_firmantes[]" class="display_none"></select>
    ...
    <div class="row">
        <div class="col-md-5 margen_x_10">
            <h3><strong>Signatarios disponibles</strong></h3>
            ...
            <br>
            <div id="lista_firmantes_disponibles" class="row scroll_vertical_auto listas_firmantes">
            </div>
        </div>
        <div class="col-md-5 margen_x_10">
            <h3 class="margen_sup_23"><strong>Signatarios seleccionados</strong></h3>
            ...
            <div id="lista_firmantes" class="row scroll_vertical_auto listas_firmantes margen_sup_20">
            </div>
        </div>
    </div>
</form>
