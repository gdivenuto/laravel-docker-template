...
<div class="row borde-inferior">
    ...
    <div class="col-md-5 margen_sup_10">
        <h3>Estos documentos se encuentran pendientes de firma.</h3>
    </div>
</div>
<div class="row borde-inferior">
    <div class="col-md-12 responsive">
        <!-- Grilla -->
        <div class="row">
            <div id="grillaFirmasContainer" class="col-md-12 responsive contenedor-grilla">
