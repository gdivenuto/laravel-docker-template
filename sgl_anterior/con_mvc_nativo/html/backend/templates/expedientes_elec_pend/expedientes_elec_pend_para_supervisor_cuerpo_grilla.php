...
<div class="row borde-inferior">
    <div class="col-md-6">
        <h2>Documentos electrónicos pendientes de revisi&oacute;n</h2>
    </div>
    <div class="col-md-6 margen_sup_10">
        <h3>Estos documentos electr&oacute;nicos requieren atenci&oacute;n por estar pendientes de una revisi&oacute;n previa antes de ser agregados a un Expediente Electr&oacute;nico.</h3>
    </div>
</div>
<div class="row borde-inferior">
    <div class="col-md-12 responsive">
        <!-- Grilla -->
        <div class="row">
            <div id="grillaRevisionesPendientesParaSupervisorContainer" class="col-md-12 responsive contenedor-grilla">
