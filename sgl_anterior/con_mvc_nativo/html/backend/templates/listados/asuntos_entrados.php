...
$f_fecha_desde = $this->vista->data['parametros_asuntos_entrados']['f_fecha_desde'];
$f_fecha_hasta = $this->vista->data['parametros_asuntos_entrados']['f_fecha_hasta'];
...
<div class="row borde-inferior">
    <div class="col-md-12 titulo-codificadora">
        <span class="glyphicon glyphicon-file"></span><strong>Asuntos Entrados</strong>
    </div>
</div>
<div class="row">
    ...
    <div class="col-md-12 responsive">
        <div class="row borde-inferior">
            ...
            <form id="form_asuntos_entrados" name="form_asuntos_entrados" class="form-horizontal" action="index.php?c=listadoexpedientesencomision&a=view" method="POST">
                ...
                <div class="col-sm-6 col-md-7 col-lg-7 text-center">
