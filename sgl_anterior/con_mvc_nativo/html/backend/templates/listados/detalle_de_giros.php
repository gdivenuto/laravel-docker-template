...
$f_fecha_desde    = $this->vista->data['parametros_detalle_de_giros']['f_fecha_desde'];
$f_fecha_hasta    = $this->vista->data['parametros_detalle_de_giros']['f_fecha_hasta'];
$f_fecha_comision = $this->vista->data['parametros_detalle_de_giros']['f_fecha_comision'];
$f_comision       = $this->vista->data['parametros_detalle_de_giros']['f_comision'];
$f_estado         = $this->vista->data['parametros_detalle_de_giros']['f_estado'];

// Para mostrar en los Calendarios de fecha Desde, fecha Hasta y fecha de Comisión
...
<div class="row borde-inferior">
    <div class="col-md-12 titulo-codificadora">
        <span class="glyphicon glyphicon-file"></span><strong>Expedientes con detalle de Giros</strong>
    </div>
</div>
<div class="row">
    ...
    <div class="col-md-12 responsive">
        <div class="row borde-inferior">
            ...
            <form id="form_detalle_de_giros" name="form_detalle_de_giros" class="form-horizontal" action="index.php?c=listadodetalledegiros&a=view" method="POST">
                
                <!-- Fechas Desde y Hasta + En Comisión antes del... -->
                <div class="col-sm-6 col-md-5 col-lg-4">
                    ...
                    <!-- En Comisión antes del... -->
                    <div class="form-group">
                        <label for="v_fecha_comision" class="col-xs-7 col-sm-8 col-md-8 col-lg-10 control-label">Ingresados en la Comisi&oacute;n antes del:</label>
                        <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                ...
                <!-- Combos de Comisión y Estado  -->
                <div class="col-sm-6 col-md-7 col-lg-8">
                    <!-- Comisión -->
                    <div class="form-group">
                        <label for="f_comision" class="col-xs-2 col-sm-2 col-md-4 col-lg-4 control-label">Comisi&oacute;n:</label>
                    ...
                    <!-- Estado -->
                    <div class="form-group">
                        <label for="f_estado" class="col-xs-2 col-sm-2 col-md-4 col-lg-4 control-label">Estado:</label>
                        <div class="col-xs-10 col-sm-10 col-md-8 col-lg-8">
                            <div class="input-group">
