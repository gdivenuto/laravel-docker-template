...
$f_fecha_desde = $this->vista->data['parametros_listado_sin_documento_cargado']['f_fecha_desde'];
$f_fecha_hasta = $this->vista->data['parametros_listado_sin_documento_cargado']['f_fecha_hasta'];
...
<div class="row borde-inferior">
    <div class="col-md-12 titulo-codificadora">
        <span class="glyphicon glyphicon-file"></span><strong>Expedientes sin documento cargado</strong>
    </div>
</div>
<div class="row">
    ...
    <div class="col-md-12 responsive">
        <div class="row borde-inferior">
            ...
            <form id="form_sin_documento_cargado" name="form_sin_documento_cargado" class="form-horizontal" action="index.php?c=listadoexpedientessindocumentocargado&a=view" method="POST">
                <!-- Fecha Desde y Hasta -->
