...
$f_fecha_desde          = $this->vista->data['parametros_expedientes_en_prestamo']['f_fecha_desde'];
$f_fecha_hasta          = $this->vista->data['parametros_expedientes_en_prestamo']['f_fecha_hasta'];
$f_estado               = $this->vista->data['parametros_expedientes_en_prestamo']['f_estado'];
$f_observaciones_estado = $this->vista->data['parametros_expedientes_en_prestamo']['f_observaciones_estado'];
...
// Listado para cargar el combo de Estados del buscador
...
<div class="row borde-inferior">
    <div class="col-md-12 titulo-codificadora">
        <span class="glyphicon glyphicon-file"></span><strong>Expedientes en Pr&eacute;stamo</strong>
    </div>
</div>
<div class="row">
    ...
    <div class="col-md-12 responsive">
        <div class="row borde-inferior">
            ...
            <form id="form_expedientes_en_prestamo" name="form_expedientes_en_prestamo" class="form-horizontal" action="index.php?c=listadoexpedientesenprestamo&a=view" method="POST">
                
                <div class="col-sm-5 col-md-3 col-lg-3">
                    <!-- Fechas Desde y Hasta -->
                    <div class="form-group">
                        <label for="v_fecha_desde" class="col-xs-2 col-sm-2 col-md-4 col-lg-4 control-label">Desde:</label>
                ...
                <div class="col-sm-7 col-md-4 col-lg-4">
                    <!-- Estado -->
                    <div class="form-group">
                        <label class="col-xs-2 col-sm-2 col-md-2 col-lg-4 control-label">Estado:</label>
                ...
                <div class="col-sm-12 col-md-5 col-lg-5">
                    ...
                    <div class="form-group">
                        <label class="col-xs-2 col-sm-3 col-md-3 col-lg-3 control-label text-left">
                            <span class="label_corto_observaciones">Observ.:</span>
                            <span class="label_largo_observaciones">Observaciones:</span>
                        </label>
                        <div class="col-xs-10 col-sm-9 col-md-9 col-lg-9">
                            <!-- Por observaciones del Estado -->
                            <input type="text" id="f_observaciones_estado" name="f_observaciones_estado" class="form-control input-sm" value="<?php echo $f_observaciones_estado; ?>" placeholder="Por observaciones del Estado" />
                        </div>
                    </div>
                </div>
