...
header('Content-Disposition: inline; filename=expedientes_en_prestamo.doc');
...
echo "\n<p style='margin:0cm;'>Honorable Concejo Deliberante</p>";
echo "\n<hr>";
echo "\n<p style='margin:0cm;margin-bottom:.0001pt;'><b>Expedientes en Pr&eacute;stamo</b></p>";