...
<div class="row">
    ...
    <div class="col-md-9 responsive">
        ...
        ?>
            ...
            <div class="col-sm-1 responsive">
                <div class="row text-right margen_sup_5">
                    <button id="btn_nuevo_giro" type="button" class="btn btn-primary btn-sm boton-adaptado"><span class="glyphicon glyphicon-plus"></span>&nbsp;Nuevo Giro</button>
                </div>
            </div>
        <?php
        }
        ...
        <!-- Grilla -->
        <div class="row">
            <div id="grillaGirosContainer" class="col-md-12 responsive contenedor-grilla">
