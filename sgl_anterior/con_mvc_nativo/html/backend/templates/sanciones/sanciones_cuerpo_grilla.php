    ...
    <div class="col-md-9 responsive">
        ...
        ?>
            ...
            <div class="col-sm-1 responsive">
                <div class="row text-right margen_sup_5">
                    <button id="btn_nueva_sancion" type="button" class="btn btn-primary btn-sm boton-adaptado"><span class="glyphicon glyphicon-plus"></span>&nbsp;Nueva Sanci&oacute;n</button>
                </div>
            </div>
        <?php
        }
        ...
        <!-- Grilla -->
        <div class="row">
            <div id="grillaSancionesContainer" class="col-md-12 responsive contenedor-grilla">
