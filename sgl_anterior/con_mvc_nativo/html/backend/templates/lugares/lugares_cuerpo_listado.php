...
<div id="contenedor-botones-dt" class="dataTables_filter">
    <button id="btn_nuevo_lugar" type="button" class="btn btn-primary btn-sm boton-adaptado"><span class="glyphicon glyphicon-plus"></span>&nbsp;Nueva</button>
...
<div class="row">
    <div class="col-md-12 responsive">
        <div class="row">
            <div id="grillaLugaresContainer" class="col-md-12 responsive contenedor-grilla contenedora-grilla-codificadora">
