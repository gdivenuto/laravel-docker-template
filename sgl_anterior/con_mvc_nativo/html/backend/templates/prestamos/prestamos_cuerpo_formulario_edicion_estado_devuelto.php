...
<div class="row borde-inferior">
    <div class="col-md-12">
        <h4><span class="glyphicon glyphicon-edit"></span>&nbsp;<b>Devolver</b> Expediente <?php echo $prestamo->anio.'-'.$prestamo->tipo.'-'.$prestamo->numero.'-'.$prestamo->cuerpo.'-'.$prestamo->alcance; ?></h4>
    </div>
</div>
