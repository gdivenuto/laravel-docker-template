...
<div class="row borde-inferior">
    <div class="col-md-12">
        <h4><span class="glyphicon glyphicon-edit"></span>&nbsp;<b>Anular</b> pr&eacute;stamo del Expediente <?php echo $prestamo->anio.'-'.$prestamo->tipo.'-'.$prestamo->numero.'-'.$prestamo->cuerpo.'-'.$prestamo->alcance; ?></h4>
    </div>
</div>
<form id="formEdicionPrestamo" name="formEdicionPrestamo" class="form-horizontal" role="form">
    ...
    <div class="container-fluid">
        <div class="form-group">
            ...
            <label for="f_nueva_hora" class="col-xs-3 col-sm-2 col-md-2 col-lg-1 control-label">Hora</label>
            <div class="col-xs-3 col-sm-2 col-md-1 col-lg-1">
