...
<form id="formEdicionPrestamo" name="formEdicionPrestamo" class="form-horizontal" role="form">
    <div class="container-fluid">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-5">
                <textarea id="f_observaciones_prestamo" name="f_observaciones_prestamo" class="form-control" rows="12"><?php //echo ($datos['a_observaciones'] != '') ? $datos['a_observaciones'] : ''; ?></textarea>
             </div>
        </div>
        <br>
        <div class="row">
