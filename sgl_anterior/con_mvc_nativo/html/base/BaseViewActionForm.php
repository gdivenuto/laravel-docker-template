 ...
 * Define un comportamiento por defecto para una vista base que se corresponda a un formulario. 
 */
class BaseViewActionForm extends BaseViewAction {
	// ************************************************************************
	...
	public function generarHtmlHeader()
	{
		...
		require($this->vista->baseTemplatePath.'form_head.php');
	}
	...
	public function generarHtmlHeaderJS()
	{
		...
		// El resto de los componentes esta en form_head.php
		echo '<script type="text/javascript" src="'.$this->vista->baseUrl.'js/form-control.js"></script>'."\n";
	}
