 ...
 * Define un comportamiento por defecto para una vista base que se corresponda a una grilla. 
 */
class BaseViewActionGrid extends BaseViewAction {
	// ************************************************************************
	...
	public function generarHtmlHeader()
	{
		...
		// Comportamiento para grillas
		//echo "\n<!-- ".get_class($this).".generarHtmlHeader() -->\n";
		//require($this->vista->baseTemplatePath.'grid_head.php');
	}
	...
	public function generarHtmlHeaderJS()
	{
		...
		// Agrego los JS que permiten el uso de formularios
		echo "\n<!-- ".get_class($this).".generarHtmlHeaderJS() -->\n";
		// El resto de los componentes esta en grid_head.php
		echo '<script type="text/javascript" src="'.$this->vista->baseUrl.'js/grid-control.js"></script>'."\n";
	}
