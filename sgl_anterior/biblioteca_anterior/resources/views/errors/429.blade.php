    ...
    <main class="py-4">
        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="jumbotron">
                        <h2 class="display-4"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i> Demasiadas peticiones</h2>
                        <hr>
                        <p class="lead">Ha superado el máximo de peticiones por minuto para una consulta determinada. Aguarde unos minutos e intente nuevamente.</p>
